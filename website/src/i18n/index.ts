...
export const ui = {
  en: {
    ...
    'site.description': 'DeskMate monitors AI coding agents, shows non-intrusive completion alerts, and jumps back to the exact editor window, workspace, or Codex thread.',
    'hero.tagline': 'Monitor AI coding agents and jump back to the exact editor window or thread.',
    'hero.tagline.win': 'Monitor AI coding agents and jump back to the exact editor window.',
    ...
    'hero.feature2.title': 'Precise Jump Back',
    'hero.feature2.desc': 'Auto-discovers OpenClaw, Claude Code, Codex, and Cursor sessions, then jumps back to the matching editor window, workspace, or Codex thread.',
    'hero.feature2.desc.win': 'Auto-discovers OpenClaw, Claude Code, and Cursor sessions, then jumps back to the matching editor window or workspace.',
  ...
  zh: {
    ...
    'site.description': 'DeskMate 监控 AI 编程 agent，低打扰提示完成结果，并跳转回对应编辑器窗口、工作区或 Codex 线程。',
    'hero.tagline': '监控 AI 编程 agent，并跳回对应的编辑器窗口或线程。',
    'hero.tagline.win': '监控 AI 编程 agent，并跳回对应的编辑器窗口。',
    ...
    'hero.feature2.title': '精确跳回现场',
    'hero.feature2.desc': '自动发现 OpenClaw、Claude Code、Codex 和 Cursor 会话，并跳回对应编辑器窗口、工作区或 Codex 线程。',
    'hero.feature2.desc.win': '自动发现 OpenClaw、Claude Code 和 Cursor 会话，并跳回对应编辑器窗口或工作区。',
